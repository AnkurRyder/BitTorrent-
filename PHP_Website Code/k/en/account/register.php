        ...
        <div class="row">
            ...
            <hr>
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" data-toggle="validator" id="form">
                    ...
                    <!-- Profile Image -->
                    <div class="form-group row">
                      <label for="inputLink" class="col-sm-2 col-form-label">Image Link</label>
                      <div class="col-sm-10">
                        <input name="link" type="text" class="form-control" id="inputlink" placeholder="Link" data-error="Invalid Image address" required>
                        <div class="help-block with-errors"></div>
                      </div>
                    </div>
